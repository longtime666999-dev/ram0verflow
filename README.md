...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3707"><img src="assets/ledger-light.svg?v=3707" width="100%" alt="ROFL ledger, height 3707"></picture>

| | |
|---|---|
| **height** | `3707` |
| **tip** | `af8984851d8123d3fb6a4156d9d4a682f6f278e0af6633539c0412599b4b3428` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,774,376,424` expected hashes |
| **supply** | `20999.89241568 ROFL` in `3708` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1596` | `43.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95223959 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3707. Verify it yourself: <code>python3 verify.py</code></sub>
