...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3673"><img src="assets/ledger-light.svg?v=3673" width="100%" alt="ROFL ledger, height 3673"></picture>

| | |
|---|---|
| **height** | `3673` |
| **tip** | `769db98c2850604339036270e4c341abeca7bc3afd7dcbb3fa81c08fc1c46bc6` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,738,724,874` expected hashes |
| **supply** | `20999.87944604 ROFL` in `3674` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1564` | `42.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94003287 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3673. Verify it yourself: <code>python3 verify.py</code></sub>
