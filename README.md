...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3704"><img src="assets/ledger-light.svg?v=3704" width="100%" alt="ROFL ledger, height 3704"></picture>

| | |
|---|---|
| **height** | `3704` |
| **tip** | `b43caf348dfebaf67f9c4c49c9a3cb2c37c770f1d501eeee8be2e36f5a4ea05d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,771,230,699` expected hashes |
| **supply** | `20999.89127130 ROFL` in `3705` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1593` | `43.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95109521 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3704. Verify it yourself: <code>python3 verify.py</code></sub>
