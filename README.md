...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3648"><img src="assets/ledger-light.svg?v=3648" width="100%" alt="ROFL ledger, height 3648"></picture>

| | |
|---|---|
| **height** | `3648` |
| **tip** | `aa780a85975fb8ab81b71b3bae324432001a2dd6ce8b07e5c82f996eed3cf85d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,712,510,499` expected hashes |
| **supply** | `20999.86990954 ROFL` in `3649` unspent outputs |
...
| `3639` | `b61ccb52083e26278899…` | [@ywltby](https://github.com/ywltby) | `不要小瞧EDG所有人的羁绊啊。` | `1` | `0.00038146` | 2026-09-25 04:12 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1540` | `42.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.93087783 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3648. Verify it yourself: <code>python3 verify.py</code></sub>
