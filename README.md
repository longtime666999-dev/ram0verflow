...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3680"><img src="assets/ledger-light.svg?v=3680" width="100%" alt="ROFL ledger, height 3680"></picture>

| | |
|---|---|
| **height** | `3680` |
| **tip** | `7db964211303c1f525f7986eb378edce88aefd6fe612f2617fda2d710ab2fdf8` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,746,064,899` expected hashes |
| **supply** | `20999.88211626 ROFL` in `3681` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3680` | `7db964211303c1f525f7…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.00038146` | 2026-09-25 13:41 UTC |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94194017 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3680. Verify it yourself: <code>python3 verify.py</code></sub>
