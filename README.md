...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3787"><img src="assets/ledger-light.svg?v=3787" width="100%" alt="ROFL ledger, height 3787"></picture>

| | |
|---|---|
| **height** | `3787` |
| **tip** | `eb50125186bd3c821140c5234dd6cb1da5590d60b883611c4cef1459ab4820d3` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,858,262,424` expected hashes |
| **supply** | `20999.92140664 ROFL` in `3788` unspent outputs |
...
| `3778` | `a902cfb72b5149ebdec0…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00038146` | 2026-09-26 12:32 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1674` | `44.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.98046763 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3787. Verify it yourself: <code>python3 verify.py</code></sub>
