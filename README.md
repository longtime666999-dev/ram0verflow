...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3783"><img src="assets/ledger-light.svg?v=3783" width="100%" alt="ROFL ledger, height 3783"></picture>

| | |
|---|---|
| **height** | `3783` |
| **tip** | `5171947d82dbbf8286aa415aa87702ece0d70d760f58e84d91e8a6a8fe68f1b5` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,854,068,124` expected hashes |
| **supply** | `20999.92064372 ROFL` in `3784` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1670` | `44.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97970471 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3783. Verify it yourself: <code>python3 verify.py</code></sub>
