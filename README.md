...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3544"><img src="assets/ledger-light.svg?v=3544" width="100%" alt="ROFL ledger, height 3544"></picture>

| | |
|---|---|
| **height** | `3544` |
| **tip** | `7768c66e00565087004df9eeaea6b48c4399e3e4d3fdbb71cdf28e68bedf1475` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,603,458,699` expected hashes |
| **supply** | `20999.82070095 ROFL` in `3545` unspent outputs |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3544. Verify it yourself: <code>python3 verify.py</code></sub>
