...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3781"><img src="assets/ledger-light.svg?v=3781" width="100%" alt="ROFL ledger, height 3781"></picture>

| | |
|---|---|
| **height** | `3781` |
| **tip** | `9ad28eb65e66d20a291485e197040eb5ecf9613dc9eabf5bf2aea66d3fb46c44` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,851,970,974` expected hashes |
| **supply** | `20999.92026226 ROFL` in `3782` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1668` | `44.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97932325 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3781. Verify it yourself: <code>python3 verify.py</code></sub>
