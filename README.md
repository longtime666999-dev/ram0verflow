...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3607"><img src="assets/ledger-light.svg?v=3607" width="100%" alt="ROFL ledger, height 3607"></picture>

| | |
|---|---|
| **height** | `3607` |
| **tip** | `d923562bb0c264253a2154ab9fbd80838fb2fb7110f4633eb17e7b2d33646d99` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,669,518,924` expected hashes |
| **supply** | `20999.85426968 ROFL` in `3608` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1499` | `41.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91523797 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3607. Verify it yourself: <code>python3 verify.py</code></sub>
