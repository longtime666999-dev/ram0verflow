...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3616"><img src="assets/ledger-light.svg?v=3616" width="100%" alt="ROFL ledger, height 3616"></picture>

| | |
|---|---|
| **height** | `3616` |
| **tip** | `83e13c680234ac178c3172dc4ff1a9df9a30511d8d06f0a7fd7210cc9c6ad9d9` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,678,956,099` expected hashes |
| **supply** | `20999.85770282 ROFL` in `3617` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1508` | `41.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91867111 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3616. Verify it yourself: <code>python3 verify.py</code></sub>
