...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3621"><img src="assets/ledger-light.svg?v=3621" width="100%" alt="ROFL ledger, height 3621"></picture>

| | |
|---|---|
| **height** | `3621` |
| **tip** | `99c79b3c81d186680db1299fb2bb30bb6c1f0c72ab9fa5cd89ecdddb981c9d5d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,684,198,974` expected hashes |
| **supply** | `20999.85961012 ROFL` in `3622` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1513` | `41.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92057841 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3621. Verify it yourself: <code>python3 verify.py</code></sub>
