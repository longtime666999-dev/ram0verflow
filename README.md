...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3696"><img src="assets/ledger-light.svg?v=3696" width="100%" alt="ROFL ledger, height 3696"></picture>

| | |
|---|---|
| **height** | `3696` |
| **tip** | `3fd2231eae0acfae6e8b7a7790c390a77e4e07f4fb6f9984e6f75697c7859d7c` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,762,842,099` expected hashes |
| **supply** | `20999.88821962 ROFL` in `3697` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3696` | `3fd2231eae0acfae6e8b…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00038146` | 2026-09-25 17:32 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1585` | `42.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94804353 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3696. Verify it yourself: <code>python3 verify.py</code></sub>
