...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3758"><img src="assets/ledger-light.svg?v=3758" width="100%" alt="ROFL ledger, height 3758"></picture>

| | |
|---|---|
| **height** | `3758` |
| **tip** | `142c0d19045db428865cb70bf2d15dbffa67dd461dbee9e3ba6621c81d230067` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,827,853,749` expected hashes |
| **supply** | `20999.91187014 ROFL` in `3759` unspent outputs |
...
| `3749` | `07e2f980f3d72ec04576…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.00038146` | 2026-09-26 05:31 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1646` | `43.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97131259 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3758. Verify it yourself: <code>python3 verify.py</code></sub>
