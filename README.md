...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3627"><img src="assets/ledger-light.svg?v=3627" width="100%" alt="ROFL ledger, height 3627"></picture>

| | |
|---|---|
| **height** | `3627` |
| **tip** | `8bd5a6506ebab78770cda4ad60334dcca69229497f955cd3c6277891ba192274` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,690,490,424` expected hashes |
| **supply** | `20999.86189888 ROFL` in `3628` unspent outputs |
...
| `3618` | `0699ff0a090c28dfcb33…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00038146` | 2026-09-24 23:23 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1519` | `41.9%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `13.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92286717 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3627. Verify it yourself: <code>python3 verify.py</code></sub>
