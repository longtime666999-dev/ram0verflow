...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3713"><img src="assets/ledger-light.svg?v=3713" width="100%" alt="ROFL ledger, height 3713"></picture>

| | |
|---|---|
| **height** | `3713` |
| **tip** | `fa62796ec08d4ff0bf00ae547f7014a577fa23cfed5d3450dc5994992d90c479` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,780,667,874` expected hashes |
| **supply** | `20999.89470444 ROFL` in `3714` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1602` | `43.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95452835 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3713. Verify it yourself: <code>python3 verify.py</code></sub>
