...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3620"><img src="assets/ledger-light.svg?v=3620" width="100%" alt="ROFL ledger, height 3620"></picture>

| | |
|---|---|
| **height** | `3620` |
| **tip** | `811b3ba02921176e64fb12d23b778dbf8fbb0bf556de6b96a57fe9af91344716` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,683,150,399` expected hashes |
| **supply** | `20999.85922866 ROFL` in `3621` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1512` | `41.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92019695 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3620. Verify it yourself: <code>python3 verify.py</code></sub>
