...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3744"><img src="assets/ledger-light.svg?v=3744" width="100%" alt="ROFL ledger, height 3744"></picture>

| | |
|---|---|
| **height** | `3744` |
| **tip** | `e34cd89f8b75e9d0653f8bd4437ef4f403b91ffa5549170c39d88a3942d1af63` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,813,173,699` expected hashes |
| **supply** | `20999.90652970 ROFL` in `3745` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1632` | `43.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96597215 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3744. Verify it yourself: <code>python3 verify.py</code></sub>
