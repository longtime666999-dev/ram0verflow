...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3604"><img src="assets/ledger-light.svg?v=3604" width="100%" alt="ROFL ledger, height 3604"></picture>

| | |
|---|---|
| **height** | `3604` |
| **tip** | `9229cd0a8bd1f59c7d7c8819332a409fc5de69a9788215f905a0f4aa5751a742` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,666,373,199` expected hashes |
| **supply** | `20999.85312530 ROFL` in `3605` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1496` | `41.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91409359 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3604. Verify it yourself: <code>python3 verify.py</code></sub>
