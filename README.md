...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3647"><img src="assets/ledger-light.svg?v=3647" width="100%" alt="ROFL ledger, height 3647"></picture>

| | |
|---|---|
| **height** | `3647` |
| **tip** | `1447531ef41b84a6b07a0ffdf5ca785df04ed99faf9c9db7fdac6a460250025b` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,711,461,924` expected hashes |
| **supply** | `20999.86952808 ROFL` in `3648` unspent outputs |
...
| `3638` | `2b8acd6eb3098e152052…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00038146` | 2026-09-25 03:57 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1539` | `42.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.93049637 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3647. Verify it yourself: <code>python3 verify.py</code></sub>
