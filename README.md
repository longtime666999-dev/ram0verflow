...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3622"><img src="assets/ledger-light.svg?v=3622" width="100%" alt="ROFL ledger, height 3622"></picture>

| | |
|---|---|
| **height** | `3622` |
| **tip** | `417ff094cea91fe1451054912a0a46af67804863daf38a83e09cc39b836de7c5` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,685,247,549` expected hashes |
| **supply** | `20999.85999158 ROFL` in `3623` unspent outputs |
...
| `3613` | `72c865868ee08d778fa6…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00038146` | 2026-09-24 22:10 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1514` | `41.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92095987 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3622. Verify it yourself: <code>python3 verify.py</code></sub>
