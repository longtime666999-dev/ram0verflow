...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3684"><img src="assets/ledger-light.svg?v=3684" width="100%" alt="ROFL ledger, height 3684"></picture>

| | |
|---|---|
| **height** | `3684` |
| **tip** | `27ac38aacd7abd9413230e6e5035c4ebae95eb0dc681affe452adbb48e18f4ec` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,750,259,199` expected hashes |
| **supply** | `20999.88364210 ROFL` in `3685` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3684` | `27ac38aacd7abd941323…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.00038146` | 2026-09-25 14:35 UTC |
| `3683` | `ccbe9a58da3c314eff17…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00038146` | 2026-09-25 14:26 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1573` | `42.7%` |
| [@ksanjeev284](https://github.com/ksanjeev284) | `488` | `13.2%` |
| [@americanvain](https://github.com/americanvain) | `315` | `8.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94346601 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3684. Verify it yourself: <code>python3 verify.py</code></sub>
