...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3726"><img src="assets/ledger-light.svg?v=3726" width="100%" alt="ROFL ledger, height 3726"></picture>

| | |
|---|---|
| **height** | `3726` |
| **tip** | `75861d4fdd93f1f1aa656720d6d12c2aea78da940022f576eeba9c65f15073eb` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,794,299,349` expected hashes |
| **supply** | `20999.89966342 ROFL` in `3727` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1615` | `43.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95948733 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3726. Verify it yourself: <code>python3 verify.py</code></sub>
