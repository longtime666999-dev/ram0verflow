...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3782"><img src="assets/ledger-light.svg?v=3782" width="100%" alt="ROFL ledger, height 3782"></picture>

| | |
|---|---|
| **height** | `3782` |
| **tip** | `212137bf49576e0f4b1d6010c86c07013723dc468bdea4bbc514084335566b2d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,853,019,549` expected hashes |
| **supply** | `20999.92045299 ROFL` in `3783` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1669` | `44.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97951398 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3782. Verify it yourself: <code>python3 verify.py</code></sub>
