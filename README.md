...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3683"><img src="assets/ledger-light.svg?v=3683" width="100%" alt="ROFL ledger, height 3683"></picture>

| | |
|---|---|
| **height** | `3683` |
| **tip** | `ccbe9a58da3c314eff17f962f578e5914c8093bd42dadb5a99dd03ab26200a33` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,749,210,624` expected hashes |
| **supply** | `20999.88326064 ROFL` in `3684` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1572` | `42.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94308455 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3683. Verify it yourself: <code>python3 verify.py</code></sub>
