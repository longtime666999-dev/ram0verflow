...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3740"><img src="assets/ledger-light.svg?v=3740" width="100%" alt="ROFL ledger, height 3740"></picture>

| | |
|---|---|
| **height** | `3740` |
| **tip** | `85f2434ae229d178f01233d1147095e70491b2ae87b5a7e834ca72123bd9fd0c` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,808,979,399` expected hashes |
| **supply** | `20999.90500386 ROFL` in `3741` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3740` | `85f2434ae229d178f012…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00038146` | 2026-09-26 03:28 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1628` | `43.5%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96444631 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3740. Verify it yourself: <code>python3 verify.py</code></sub>
