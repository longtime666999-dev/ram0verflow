...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3773"><img src="assets/ledger-light.svg?v=3773" width="100%" alt="ROFL ledger, height 3773"></picture>

| | |
|---|---|
| **height** | `3773` |
| **tip** | `a1627ff43fff83eccacf3a644de579eff73aa7ba53bd77e8a78d25273b056624` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,843,582,374` expected hashes |
| **supply** | `20999.91759204 ROFL` in `3774` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3773` | `a1627ff43fff83eccacf…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.00038146` | 2026-09-26 11:23 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1660` | `44.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97665303 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3773. Verify it yourself: <code>python3 verify.py</code></sub>
