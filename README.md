...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3686"><img src="assets/ledger-light.svg?v=3686" width="100%" alt="ROFL ledger, height 3686"></picture>

| | |
|---|---|
| **height** | `3686` |
| **tip** | `bb8a166627de4d5693de58f81b80460a61374eeac75fb491b0a72cf5fa7b084f` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,752,356,349` expected hashes |
| **supply** | `20999.88440502 ROFL` in `3687` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3686` | `bb8a166627de4d5693de…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.00038146` | 2026-09-25 15:02 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1575` | `42.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94422893 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3686. Verify it yourself: <code>python3 verify.py</code></sub>
