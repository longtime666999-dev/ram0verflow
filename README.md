...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3681"><img src="assets/ledger-light.svg?v=3681" width="100%" alt="ROFL ledger, height 3681"></picture>

| | |
|---|---|
| **height** | `3681` |
| **tip** | `c65d30b920cd97cf50862108de9df35baa58de17fd0ef55ae2d2246905f18cab` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,747,113,474` expected hashes |
| **supply** | `20999.88249772 ROFL` in `3682` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1570` | `42.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94232163 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3681. Verify it yourself: <code>python3 verify.py</code></sub>
