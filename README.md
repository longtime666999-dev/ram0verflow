...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3724"><img src="assets/ledger-light.svg?v=3724" width="100%" alt="ROFL ledger, height 3724"></picture>

| | |
|---|---|
| **height** | `3724` |
| **tip** | `d667cd7853b19637cba933837ddb1ff317ed4b1b765f56fbcb4995826ad33ce4` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,792,202,199` expected hashes |
| **supply** | `20999.89890050 ROFL` in `3725` unspent outputs |
...
| `3717` | `17caca9cd8f672e2063b…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00038146` | 2026-09-25 22:39 UTC |
| `3716` | `ebe7686dc7fc8785942d…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00038146` | 2026-09-25 22:23 UTC |
| `3715` | `818a4fc2eb296c24ea2a…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.00038146` | 2026-09-25 22:07 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1613` | `43.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95872441 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3724. Verify it yourself: <code>python3 verify.py</code></sub>
