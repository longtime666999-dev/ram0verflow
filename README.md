...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3703"><img src="assets/ledger-light.svg?v=3703" width="100%" alt="ROFL ledger, height 3703"></picture>

| | |
|---|---|
| **height** | `3703` |
| **tip** | `88057bbbe8685c4eb760eb66ccc5c0bd6e18578cbc4bb91cce10041c8887ae50` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,770,182,124` expected hashes |
| **supply** | `20999.89088984 ROFL` in `3704` unspent outputs |
...
| `3698` | `1f0082e2ec36325371f8…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00038146` | 2026-09-25 18:03 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1592` | `43.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95071375 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3703. Verify it yourself: <code>python3 verify.py</code></sub>
