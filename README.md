...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3660"><img src="assets/ledger-light.svg?v=3660" width="100%" alt="ROFL ledger, height 3660"></picture>

| | |
|---|---|
| **height** | `3660` |
| **tip** | `4f9794d319b29f67caff3bd5a1a7a9df5efd3f41bb054b73b5fd034ed4f36178` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,725,093,399` expected hashes |
| **supply** | `20999.87448706 ROFL` in `3661` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1552` | `42.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.93545535 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3660. Verify it yourself: <code>python3 verify.py</code></sub>
