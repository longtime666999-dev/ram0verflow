...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3599"><img src="assets/ledger-light.svg?v=3599" width="100%" alt="ROFL ledger, height 3599"></picture>

| | |
|---|---|
| **height** | `3599` |
| **tip** | `2d332e289a3d222f0c18a0126556d18fa44db47e6904fd5a515af15a278df657` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,661,130,324` expected hashes |
| **supply** | `20999.85121800 ROFL` in `3600` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1491` | `41.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91218629 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3599. Verify it yourself: <code>python3 verify.py</code></sub>
