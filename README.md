...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3554"><img src="assets/ledger-light.svg?v=3554" width="100%" alt="ROFL ledger, height 3554"></picture>

| | |
|---|---|
| **height** | `3554` |
| **tip** | `82d18883696382e020c835cc96cdb2f2d3943feb9c6ea8e0d97b46149c6e7993` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,613,944,449` expected hashes |
| **supply** | `20999.82833025 ROFL` in `3555` unspent outputs |
...
| [@daxang](https://github.com/daxang) | `rofl1qaehvw6vzus7dmrssc4rul2hgrfxdhwzc8c9h4k` | `0.01068102 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3554. Verify it yourself: <code>python3 verify.py</code></sub>
