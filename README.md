...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3725"><img src="assets/ledger-light.svg?v=3725" width="100%" alt="ROFL ledger, height 3725"></picture>

| | |
|---|---|
| **height** | `3725` |
| **tip** | `f38ab01565985409c289b8ab0d463ecea786d978a9652cf9b331f68089b1b2a6` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,793,250,774` expected hashes |
| **supply** | `20999.89928196 ROFL` in `3726` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1614` | `43.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95910587 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3725. Verify it yourself: <code>python3 verify.py</code></sub>
