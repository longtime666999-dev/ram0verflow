...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3641"><img src="assets/ledger-light.svg?v=3641" width="100%" alt="ROFL ledger, height 3641"></picture>

| | |
|---|---|
| **height** | `3641` |
| **tip** | `0ab9d6c646644059d1da59de1dd69d8f4a65cc9ebf80b152a950ecef60200de8` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,705,170,474` expected hashes |
| **supply** | `20999.86723932 ROFL` in `3642` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1533` | `42.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92820761 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3641. Verify it yourself: <code>python3 verify.py</code></sub>
