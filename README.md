...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3557"><img src="assets/ledger-light.svg?v=3557" width="100%" alt="ROFL ledger, height 3557"></picture>

| | |
|---|---|
| **height** | `3557` |
| **tip** | `b56de7a2764f26e6ec30bcac409c64f419d62652477994d26185f5d2ee6513c8` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,617,090,174` expected hashes |
| **supply** | `20999.83061904 ROFL` in `3558` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3557` | `b56de7a2764f26e6ec30…` | [@daxang](https://github.com/daxang) | `挖个矿` | `1` | `0.00076293` | 2026-09-24 09:48 UTC |
...
| [@daxang](https://github.com/daxang) | `rofl1qaehvw6vzus7dmrssc4rul2hgrfxdhwzc8c9h4k` | `0.01220688 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3557. Verify it yourself: <code>python3 verify.py</code></sub>
