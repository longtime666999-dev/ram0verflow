...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3701"><img src="assets/ledger-light.svg?v=3701" width="100%" alt="ROFL ledger, height 3701"></picture>

| | |
|---|---|
| **height** | `3701` |
| **tip** | `1f848c82b271ad4118c9acbf243d0d515735551831fd71d87bc579c1525a2b67` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,768,084,974` expected hashes |
| **supply** | `20999.89012692 ROFL` in `3702` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1590` | `42.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94995083 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3701. Verify it yourself: <code>python3 verify.py</code></sub>
