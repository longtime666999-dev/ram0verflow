...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3769"><img src="assets/ledger-light.svg?v=3769" width="100%" alt="ROFL ledger, height 3769"></picture>

| | |
|---|---|
| **height** | `3769` |
| **tip** | `5e4d8f395bb5920c4e39b047d9952a5bacbd9a0224e33b3836c89b7f48deb9d6` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,839,388,074` expected hashes |
| **supply** | `20999.91606620 ROFL` in `3770` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3769` | `5e4d8f395bb5920c4e39…` | [@ywltby](https://github.com/ywltby) | `真的假的？` | `1` | `0.00038146` | 2026-09-26 10:22 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1656` | `43.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97512719 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3769. Verify it yourself: <code>python3 verify.py</code></sub>
