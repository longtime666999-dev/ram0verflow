...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3702"><img src="assets/ledger-light.svg?v=3702" width="100%" alt="ROFL ledger, height 3702"></picture>

| | |
|---|---|
| **height** | `3702` |
| **tip** | `95532c63c13c27354a4c538c8279262e330cbfb36796ad24ed2a6fde0ec13cc3` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,769,133,549` expected hashes |
| **supply** | `20999.89050838 ROFL` in `3703` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1591` | `43.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95033229 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3702. Verify it yourself: <code>python3 verify.py</code></sub>
