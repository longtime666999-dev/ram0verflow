...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3778"><img src="assets/ledger-light.svg?v=3778" width="100%" alt="ROFL ledger, height 3778"></picture>

| | |
|---|---|
| **height** | `3778` |
| **tip** | `a902cfb72b5149ebdec0882d63e69f43fd069e355a84b913ce374b3ceb6c94b2` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,848,825,249` expected hashes |
| **supply** | `20999.91949934 ROFL` in `3779` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1665` | `44.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97856033 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3778. Verify it yourself: <code>python3 verify.py</code></sub>
