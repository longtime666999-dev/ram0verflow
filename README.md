...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3658"><img src="assets/ledger-light.svg?v=3658" width="100%" alt="ROFL ledger, height 3658"></picture>

| | |
|---|---|
| **height** | `3658` |
| **tip** | `7e95bdff37c93126a2d290c8a22d7359f1a0d23535a8c1d22e3499e697871bdf` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,722,996,249` expected hashes |
| **supply** | `20999.87372414 ROFL` in `3659` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1550` | `42.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.93469243 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3658. Verify it yourself: <code>python3 verify.py</code></sub>
