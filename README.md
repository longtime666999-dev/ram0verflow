...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3651"><img src="assets/ledger-light.svg?v=3651" width="100%" alt="ROFL ledger, height 3651"></picture>

| | |
|---|---|
| **height** | `3651` |
| **tip** | `b3cd40454d5079adc229a3b75c82da2b482864a5d56a69d791256b0f7e7877af` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,715,656,224` expected hashes |
| **supply** | `20999.87105392 ROFL` in `3652` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3651` | `b3cd40454d5079adc229…` | [@ywltby](https://github.com/ywltby) | `原神？启动！` | `1` | `0.00038146` | 2026-09-25 06:51 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1543` | `42.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.93202221 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3651. Verify it yourself: <code>python3 verify.py</code></sub>
