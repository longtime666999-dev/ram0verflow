...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3775"><img src="assets/ledger-light.svg?v=3775" width="100%" alt="ROFL ledger, height 3775"></picture>

| | |
|---|---|
| **height** | `3775` |
| **tip** | `8f22003a8ffc1c58a3d8dadc73166284d27af09b0052a5d16e52c23498aeaf4d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,845,679,524` expected hashes |
| **supply** | `20999.91835496 ROFL` in `3776` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3775` | `8f22003a8ffc1c58a3d8…` | [@ywltby](https://github.com/ywltby) | `现在拿了世界冠军还在骂我，那拿了世界冠军有什么用呢？` | `1` | `0.00038146` | 2026-09-26 11:49 UTC |
| `3774` | `0bbbeb940d3e26ad26a1…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00038146` | 2026-09-26 11:33 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1662` | `44.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97741595 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3775. Verify it yourself: <code>python3 verify.py</code></sub>
