...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3595"><img src="assets/ledger-light.svg?v=3595" width="100%" alt="ROFL ledger, height 3595"></picture>

| | |
|---|---|
| **height** | `3595` |
| **tip** | `f8ad9802662558a9dc103c51d0eccdbc3be047bfa903a2e2761cf229d4ed764f` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,656,936,024` expected hashes |
| **supply** | `20999.84969216 ROFL` in `3596` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1487` | `41.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91066045 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3595. Verify it yourself: <code>python3 verify.py</code></sub>
