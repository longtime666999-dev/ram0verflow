...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3749"><img src="assets/ledger-light.svg?v=3749" width="100%" alt="ROFL ledger, height 3749"></picture>

| | |
|---|---|
| **height** | `3749` |
| **tip** | `07e2f980f3d72ec04576556abccdf43994b3d1e047c125a8580d5ceb1b9c4741` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,818,416,574` expected hashes |
| **supply** | `20999.90843700 ROFL` in `3750` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1637` | `43.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96787945 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3749. Verify it yourself: <code>python3 verify.py</code></sub>
