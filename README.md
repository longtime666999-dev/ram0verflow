...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3705"><img src="assets/ledger-light.svg?v=3705" width="100%" alt="ROFL ledger, height 3705"></picture>

| | |
|---|---|
| **height** | `3705` |
| **tip** | `50bc38839017a3624c1bfdc1bfa5675a2476997f4ae7e243bf416701d4d30441` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,772,279,274` expected hashes |
| **supply** | `20999.89165276 ROFL` in `3706` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1594` | `43.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95147667 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3705. Verify it yourself: <code>python3 verify.py</code></sub>
