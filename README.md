...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3688"><img src="assets/ledger-light.svg?v=3688" width="100%" alt="ROFL ledger, height 3688"></picture>

| | |
|---|---|
| **height** | `3688` |
| **tip** | `012060fb0186063caa666644f58987b9954b578e7c0221936e134c3d689d7927` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,754,453,499` expected hashes |
| **supply** | `20999.88516794 ROFL` in `3689` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3688` | `012060fb0186063caa66…` | [@ywltby](https://github.com/ywltby) | `面善打个D啊，喜欢我的战斗脸吗？` | `1` | `0.00038146` | 2026-09-25 15:33 UTC |
| `3687` | `4a1e479c3b95bcda62aa…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.00038146` | 2026-09-25 15:17 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1577` | `42.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94499185 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3688. Verify it yourself: <code>python3 verify.py</code></sub>
