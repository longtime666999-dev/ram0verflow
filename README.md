...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3723"><img src="assets/ledger-light.svg?v=3723" width="100%" alt="ROFL ledger, height 3723"></picture>

| | |
|---|---|
| **height** | `3723` |
| **tip** | `d709452871118565da1c195f52fd2c19ebcc91ea7ab61b80ea1c45563d349e70` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,791,153,624` expected hashes |
| **supply** | `20999.89851904 ROFL` in `3724` unspent outputs |
...
| `3714` | `5496e6dc3fe99e32fcf8…` | [@ywltby](https://github.com/ywltby) | `VCTCN，你们的王回来了！` | `1` | `0.00038146` | 2026-09-25 21:51 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1612` | `43.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95834295 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3723. Verify it yourself: <code>python3 verify.py</code></sub>
