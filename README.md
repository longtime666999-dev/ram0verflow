...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3619"><img src="assets/ledger-light.svg?v=3619" width="100%" alt="ROFL ledger, height 3619"></picture>

| | |
|---|---|
| **height** | `3619` |
| **tip** | `a8401a3d65bb3d3120565b52a90ff30dcb53b43e5b1734d8b68fce432951900b` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,682,101,824` expected hashes |
| **supply** | `20999.85884720 ROFL` in `3620` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1511` | `41.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91981549 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3619. Verify it yourself: <code>python3 verify.py</code></sub>
