...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3743"><img src="assets/ledger-light.svg?v=3743" width="100%" alt="ROFL ledger, height 3743"></picture>

| | |
|---|---|
| **height** | `3743` |
| **tip** | `da8289cd60e2caf37ad0d66ac1a4765e088656acd0fe763a2c8cc9ccde30a622` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,812,125,124` expected hashes |
| **supply** | `20999.90614824 ROFL` in `3744` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1631` | `43.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96559069 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3743. Verify it yourself: <code>python3 verify.py</code></sub>
