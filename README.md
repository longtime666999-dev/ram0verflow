...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3687"><img src="assets/ledger-light.svg?v=3687" width="100%" alt="ROFL ledger, height 3687"></picture>

| | |
|---|---|
| **height** | `3687` |
| **tip** | `4a1e479c3b95bcda62aa4dc80106fa352c30fd5d2d8a6d4247e131c8b18dd248` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,753,404,924` expected hashes |
| **supply** | `20999.88478648 ROFL` in `3688` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1576` | `42.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94461039 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3687. Verify it yourself: <code>python3 verify.py</code></sub>
