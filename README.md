...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3728"><img src="assets/ledger-light.svg?v=3728" width="100%" alt="ROFL ledger, height 3728"></picture>

| | |
|---|---|
| **height** | `3728` |
| **tip** | `f00442fb55d13418e5a161f46ce03f3e885a683103a05a41bfb91d7b85b8d37c` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,796,396,499` expected hashes |
| **supply** | `20999.90042634 ROFL` in `3729` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3728` | `f00442fb55d13418e5a1…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.00038146` | 2026-09-26 01:01 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1617` | `43.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96025025 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3728. Verify it yourself: <code>python3 verify.py</code></sub>
