...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3747"><img src="assets/ledger-light.svg?v=3747" width="100%" alt="ROFL ledger, height 3747"></picture>

| | |
|---|---|
| **height** | `3747` |
| **tip** | `9cd9203a475620875e7d0af11d899af474fc11f08c3dbdfc7dd783cc2e94d97f` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,816,319,424` expected hashes |
| **supply** | `20999.90767408 ROFL` in `3748` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1635` | `43.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96711653 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3747. Verify it yourself: <code>python3 verify.py</code></sub>
