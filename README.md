...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3793"><img src="assets/ledger-light.svg?v=3793" width="100%" alt="ROFL ledger, height 3793"></picture>

| | |
|---|---|
| **height** | `3793` |
| **tip** | `9e2889232efbed65a65184146aab9112bf532a33f8859cb478ad262b5506fc4d` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,864,553,874` expected hashes |
| **supply** | `20999.92255102 ROFL` in `3794` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1680` | `44.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.98161201 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3793. Verify it yourself: <code>python3 verify.py</code></sub>
