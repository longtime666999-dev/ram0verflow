...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3759"><img src="assets/ledger-light.svg?v=3759" width="100%" alt="ROFL ledger, height 3759"></picture>

| | |
|---|---|
| **height** | `3759` |
| **tip** | `c2960d6e30afbadb89c86a2b38c62df64908ec5aabd382b4f12cd7109c2ff036` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,828,902,324` expected hashes |
| **supply** | `20999.91225160 ROFL` in `3760` unspent outputs |
...
| `3750` | `ec8ede4a6ecf70c18141…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.00038146` | 2026-09-26 05:47 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1647` | `43.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97169405 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3759. Verify it yourself: <code>python3 verify.py</code></sub>
