...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3636"><img src="assets/ledger-light.svg?v=3636" width="100%" alt="ROFL ledger, height 3636"></picture>

| | |
|---|---|
| **height** | `3636` |
| **tip** | `2883a308015aa1a2575c9c08a32b349857d7d6b81382bf715a7a2d35c8ba4d90` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,699,927,599` expected hashes |
| **supply** | `20999.86533202 ROFL` in `3637` unspent outputs |
...
| `3627` | `8bd5a6506ebab78770cd…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.00038146` | 2026-09-25 01:31 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1528` | `42.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92630031 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3636. Verify it yourself: <code>python3 verify.py</code></sub>
