...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3623"><img src="assets/ledger-light.svg?v=3623" width="100%" alt="ROFL ledger, height 3623"></picture>

| | |
|---|---|
| **height** | `3623` |
| **tip** | `d43912085cad2713299ac81a9c78eb435d11874a1c9856dbd3d8583eabf5d610` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,686,296,124` expected hashes |
| **supply** | `20999.86037304 ROFL` in `3624` unspent outputs |
...
| `3615` | `ae778ebc2e53fc7d848e…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.00038146` | 2026-09-24 22:41 UTC |
| `3614` | `da18c1e2b790587941bd…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00038146` | 2026-09-24 22:25 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1515` | `41.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92134133 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3623. Verify it yourself: <code>python3 verify.py</code></sub>
