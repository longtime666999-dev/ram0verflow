...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3706"><img src="assets/ledger-light.svg?v=3706" width="100%" alt="ROFL ledger, height 3706"></picture>

| | |
|---|---|
| **height** | `3706` |
| **tip** | `c0d681fcd8e5ffe80c6fb8fe0a3f0297b6d4ded54e3ece66a1c91f102f4166c0` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,773,327,849` expected hashes |
| **supply** | `20999.89203422 ROFL` in `3707` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1595` | `43.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95185813 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3706. Verify it yourself: <code>python3 verify.py</code></sub>
