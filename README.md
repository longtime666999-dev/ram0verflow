...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3746"><img src="assets/ledger-light.svg?v=3746" width="100%" alt="ROFL ledger, height 3746"></picture>

| | |
|---|---|
| **height** | `3746` |
| **tip** | `97469899c9b08483be4b41583272467eae7c5fbac0c50290a6b660526b52635e` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,815,270,849` expected hashes |
| **supply** | `20999.90729262 ROFL` in `3747` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1634` | `43.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96673507 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3746. Verify it yourself: <code>python3 verify.py</code></sub>
