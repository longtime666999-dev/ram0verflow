...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3594"><img src="assets/ledger-light.svg?v=3594" width="100%" alt="ROFL ledger, height 3594"></picture>

| | |
|---|---|
| **height** | `3594` |
| **tip** | `ad4439a63324e69c6c41464cdf140b8a37993246a5412da195da09fa467b3329` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,655,887,449` expected hashes |
| **supply** | `20999.84931070 ROFL` in `3595` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1486` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91027899 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3594. Verify it yourself: <code>python3 verify.py</code></sub>
