...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3691"><img src="assets/ledger-light.svg?v=3691" width="100%" alt="ROFL ledger, height 3691"></picture>

| | |
|---|---|
| **height** | `3691` |
| **tip** | `a02f864d4f14d5d2a762caed7fd37a90deb8a3b34d797e33108a93c62b01d367` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,757,599,224` expected hashes |
| **supply** | `20999.88631232 ROFL` in `3692` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1580` | `42.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94613623 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3691. Verify it yourself: <code>python3 verify.py</code></sub>
