...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3588"><img src="assets/ledger-light.svg?v=3588" width="100%" alt="ROFL ledger, height 3588"></picture>

| | |
|---|---|
| **height** | `3588` |
| **tip** | `06e086c5a1f69335c211692d3ad155bd92eba4f1541e9a46e83b0552288294bc` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,649,595,999` expected hashes |
| **supply** | `20999.84702194 ROFL` in `3589` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1482` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.90875315 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3588. Verify it yourself: <code>python3 verify.py</code></sub>
