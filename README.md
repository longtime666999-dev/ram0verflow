...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3642"><img src="assets/ledger-light.svg?v=3642" width="100%" alt="ROFL ledger, height 3642"></picture>

| | |
|---|---|
| **height** | `3642` |
| **tip** | `e0c1aa860ce33c7eb01ec8bfb44d2127021fd524f17fdd88b604fe0a6306c7c4` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,706,219,049` expected hashes |
| **supply** | `20999.86762078 ROFL` in `3643` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1534` | `42.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92858907 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3642. Verify it yourself: <code>python3 verify.py</code></sub>
