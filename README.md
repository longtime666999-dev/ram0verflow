...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3708"><img src="assets/ledger-light.svg?v=3708" width="100%" alt="ROFL ledger, height 3708"></picture>

| | |
|---|---|
| **height** | `3708` |
| **tip** | `ef7694c650fc0e9dfcd72964301621028cb52a2c6423240f9d5702e62b3cd246` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,775,424,999` expected hashes |
| **supply** | `20999.89279714 ROFL` in `3709` unspent outputs |
...
| `3699` | `7c08d7c3abf7b8e6d61e…` | [@ywltby](https://github.com/ywltby) | `天不生我ZmjjKK，瓦圈万古如长夜。` | `1` | `0.00038146` | 2026-09-25 18:19 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1597` | `43.1%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95262105 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3708. Verify it yourself: <code>python3 verify.py</code></sub>
