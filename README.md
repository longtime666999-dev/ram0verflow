...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3659"><img src="assets/ledger-light.svg?v=3659" width="100%" alt="ROFL ledger, height 3659"></picture>

| | |
|---|---|
| **height** | `3659` |
| **tip** | `082654755764c20c63a32c79a7fd5b6af14564cc044de913101913fc84c42ca1` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,724,044,824` expected hashes |
| **supply** | `20999.87410560 ROFL` in `3660` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1551` | `42.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.93507389 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3659. Verify it yourself: <code>python3 verify.py</code></sub>
