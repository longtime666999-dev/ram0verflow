...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3734"><img src="assets/ledger-light.svg?v=3734" width="100%" alt="ROFL ledger, height 3734"></picture>

| | |
|---|---|
| **height** | `3734` |
| **tip** | `bdb13605862cbfc7c23778d6a1b9f5bc7932a9e805f1dcaa1006e08a3618c163` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,802,687,949` expected hashes |
| **supply** | `20999.90271510 ROFL` in `3735` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1622` | `43.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96215755 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3734. Verify it yourself: <code>python3 verify.py</code></sub>
