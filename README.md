...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3682"><img src="assets/ledger-light.svg?v=3682" width="100%" alt="ROFL ledger, height 3682"></picture>

| | |
|---|---|
| **height** | `3682` |
| **tip** | `b8953eddfd46c84e036ffa288e668392c81c336eb6f9f6d1a1bfaf067c2090c4` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,748,162,049` expected hashes |
| **supply** | `20999.88287918 ROFL` in `3683` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3682` | `b8953eddfd46c84e036f…` | [@ywltby](https://github.com/ywltby) | `流水的天才，铁打的ZmjjKK。` | `1` | `0.00038146` | 2026-09-25 14:11 UTC |
| `3681` | `c65d30b920cd97cf5086…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00038146` | 2026-09-25 13:56 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1571` | `42.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94270309 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3682. Verify it yourself: <code>python3 verify.py</code></sub>
