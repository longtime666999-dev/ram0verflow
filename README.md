...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3692"><img src="assets/ledger-light.svg?v=3692" width="100%" alt="ROFL ledger, height 3692"></picture>

| | |
|---|---|
| **height** | `3692` |
| **tip** | `3b478f3f9532ca420d00de7b3fe3d15bae88ac0721de4c0e4b6ac1592ac54a4c` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,758,647,799` expected hashes |
| **supply** | `20999.88669378 ROFL` in `3693` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1581` | `42.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94651769 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3692. Verify it yourself: <code>python3 verify.py</code></sub>
