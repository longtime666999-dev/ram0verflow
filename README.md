...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3752"><img src="assets/ledger-light.svg?v=3752" width="100%" alt="ROFL ledger, height 3752"></picture>

| | |
|---|---|
| **height** | `3752` |
| **tip** | `a1d3625d68f15fd336cc6e07008312c151337aba41a1660bde9431e26f983c19` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,821,562,299` expected hashes |
| **supply** | `20999.90958138 ROFL` in `3753` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1640` | `43.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96902383 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3752. Verify it yourself: <code>python3 verify.py</code></sub>
