...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3753"><img src="assets/ledger-light.svg?v=3753" width="100%" alt="ROFL ledger, height 3753"></picture>

| | |
|---|---|
| **height** | `3753` |
| **tip** | `c9d4a6925f711eda9dc2bd63d97fc2bde8c11e8bd76375761742fed181e8c2db` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,822,610,874` expected hashes |
| **supply** | `20999.90996284 ROFL` in `3754` unspent outputs |
...
| `3744` | `e34cd89f8b75e9d0653f…` | [@ywltby](https://github.com/ywltby) | `遇到我们的时候，你才是挑战者。` | `1` | `0.00038146` | 2026-09-26 04:24 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1641` | `43.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96940529 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3753. Verify it yourself: <code>python3 verify.py</code></sub>
