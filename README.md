...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3722"><img src="assets/ledger-light.svg?v=3722" width="100%" alt="ROFL ledger, height 3722"></picture>

| | |
|---|---|
| **height** | `3722` |
| **tip** | `d20126403d80b74a03b73779b0677da2671b43b615841f9dcd5cca920f1cf5b7` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,790,105,049` expected hashes |
| **supply** | `20999.89813758 ROFL` in `3723` unspent outputs |
...
| `3713` | `fa62796ec08d4ff0bf00…` | [@ywltby](https://github.com/ywltby) | `以前说拿了世界冠军就不骂我了，` | `1` | `0.00038146` | 2026-09-25 21:36 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1611` | `43.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95796149 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3722. Verify it yourself: <code>python3 verify.py</code></sub>
