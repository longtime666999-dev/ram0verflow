...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3760"><img src="assets/ledger-light.svg?v=3760" width="100%" alt="ROFL ledger, height 3760"></picture>

| | |
|---|---|
| **height** | `3760` |
| **tip** | `906a540c38de4c39a964e3dba47b9799e8afaded75b36d949b108b4892a2a2a2` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,829,950,899` expected hashes |
| **supply** | `20999.91263306 ROFL` in `3761` unspent outputs |
...
| `3751` | `c6e373473bd20bd19a18…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.00038146` | 2026-09-26 06:02 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1648` | `43.8%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97207551 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3760. Verify it yourself: <code>python3 verify.py</code></sub>
