...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3615"><img src="assets/ledger-light.svg?v=3615" width="100%" alt="ROFL ledger, height 3615"></picture>

| | |
|---|---|
| **height** | `3615` |
| **tip** | `ae778ebc2e53fc7d848e57138a10eb43ed3d113f5d94976bd62fc1b566d21f82` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,677,907,524` expected hashes |
| **supply** | `20999.85732136 ROFL` in `3616` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1507` | `41.7%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.91828965 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3615. Verify it yourself: <code>python3 verify.py</code></sub>
