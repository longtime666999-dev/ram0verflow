...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3745"><img src="assets/ledger-light.svg?v=3745" width="100%" alt="ROFL ledger, height 3745"></picture>

| | |
|---|---|
| **height** | `3745` |
| **tip** | `37e59f4e1e678a738c918343fc3662030faf30cc84f6097bd609c0994629dfde` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,814,222,274` expected hashes |
| **supply** | `20999.90691116 ROFL` in `3746` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1633` | `43.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96635361 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3745. Verify it yourself: <code>python3 verify.py</code></sub>
