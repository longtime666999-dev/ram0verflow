...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3581"><img src="assets/ledger-light.svg?v=3581" width="100%" alt="ROFL ledger, height 3581"></picture>

| | |
|---|---|
| **height** | `3581` |
| **tip** | `b450b3f2756328d561cd2ec817e0ab70bf5b4e15bbfc754dda30d187eb9c5f97` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,642,255,974` expected hashes |
| **supply** | `20999.84435172 ROFL` in `3582` unspent outputs |
...
| `3572` | `da26e99129cde8f50d4b…` | [@daxang](https://github.com/daxang) | `挖个矿` | `1` | `0.00038146` | 2026-09-24 12:52 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1477` | `41.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.90684585 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3581. Verify it yourself: <code>python3 verify.py</code></sub>
