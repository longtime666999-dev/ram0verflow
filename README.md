...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3748"><img src="assets/ledger-light.svg?v=3748" width="100%" alt="ROFL ledger, height 3748"></picture>

| | |
|---|---|
| **height** | `3748` |
| **tip** | `ac0b4c10bf60f371bf12082043afb7ce9d8b48354156bf98b3c6c05df080227c` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,817,367,999` expected hashes |
| **supply** | `20999.90805554 ROFL` in `3749` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1636` | `43.6%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.96749799 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3748. Verify it yourself: <code>python3 verify.py</code></sub>
