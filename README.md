...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3685"><img src="assets/ledger-light.svg?v=3685" width="100%" alt="ROFL ledger, height 3685"></picture>

| | |
|---|---|
| **height** | `3685` |
| **tip** | `2a1e3c78e954242dce2d5a89c7f0b43aded812ba930dec3f7713b590a72460a9` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,751,307,774` expected hashes |
| **supply** | `20999.88402356 ROFL` in `3686` unspent outputs |
...
|--:|---|---|---|--:|--:|---|
| `3685` | `2a1e3c78e954242dce2d…` | [@ywltby](https://github.com/ywltby) | `康神开播了？` | `1` | `0.00038146` | 2026-09-25 14:51 UTC |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1574` | `42.7%` |
...
| [@sd5884703](https://github.com/sd5884703) | `164` | `4.4%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.94384747 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3685. Verify it yourself: <code>python3 verify.py</code></sub>
