...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3774"><img src="assets/ledger-light.svg?v=3774" width="100%" alt="ROFL ledger, height 3774"></picture>

| | |
|---|---|
| **height** | `3774` |
| **tip** | `0bbbeb940d3e26ad26a18baefca20b254d087cda8eec2b056f80763bdb4c9eb2` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,844,630,949` expected hashes |
| **supply** | `20999.91797350 ROFL` in `3775` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1661` | `44.0%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.97703449 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3774. Verify it yourself: <code>python3 verify.py</code></sub>
