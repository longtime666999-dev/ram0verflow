...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3585"><img src="assets/ledger-light.svg?v=3585" width="100%" alt="ROFL ledger, height 3585"></picture>

| | |
|---|---|
| **height** | `3585` |
| **tip** | `f06f7f2740bbf33ea65d0fc6bf7ced9922b3ec8af95f78fc56bf5ac3e14f3082` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,646,450,274` expected hashes |
| **supply** | `20999.84587756 ROFL` in `3586` unspent outputs |
...
| `3577` | `2072be868b4c656779db…` | [@daxang](https://github.com/daxang) | `挖个矿` | `1` | `0.00038146` | 2026-09-24 14:00 UTC |
| `3576` | `f782e1353d8a1f8a5323…` | [@ywltby](https://github.com/ywltby) | `输你一场，不代表我们会一直输给你。` | `1` | `0.00038146` | 2026-09-24 13:33 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1480` | `41.3%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.90799023 ROFL` |
...
| [@githubskylh](https://github.com/githubskylh) | `rofl1q4vdjjqjdeay87dmjmqu0hewv578k9uwkcf8qjf` | `0.02212517 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3585. Verify it yourself: <code>python3 verify.py</code></sub>
