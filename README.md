...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3717"><img src="assets/ledger-light.svg?v=3717" width="100%" alt="ROFL ledger, height 3717"></picture>

| | |
|---|---|
| **height** | `3717` |
| **tip** | `17caca9cd8f672e2063be8607587bb5506e0d6bed72bb6bd09321c10412d5bc5` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,784,862,174` expected hashes |
| **supply** | `20999.89623028 ROFL` in `3718` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1606` | `43.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95605419 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3717. Verify it yourself: <code>python3 verify.py</code></sub>
