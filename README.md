...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3716"><img src="assets/ledger-light.svg?v=3716" width="100%" alt="ROFL ledger, height 3716"></picture>

| | |
|---|---|
| **height** | `3716` |
| **tip** | `ebe7686dc7fc8785942d1a2c396c4bb21fb60a2e7df64e32518e7c34ac00edc1` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,783,813,599` expected hashes |
| **supply** | `20999.89584882 ROFL` in `3717` unspent outputs |
...
| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1605` | `43.2%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.95567273 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3716. Verify it yourself: <code>python3 verify.py</code></sub>
