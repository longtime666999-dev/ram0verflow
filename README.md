...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=3626"><img src="assets/ledger-light.svg?v=3626" width="100%" alt="ROFL ledger, height 3626"></picture>

| | |
|---|---|
| **height** | `3626` |
| **tip** | `521f429af0e1201dd92601ab3ae38784aa07199cd0fba4c415ad0f5f9ea4b968` |
| **difficulty** | `1.0`  (bits `0x1e100000`) |
| **chainwork** | `3,862,535,174,013,960,724,158,737,811,002,957,870,368,520,689,441,849` expected hashes |
| **supply** | `20999.86151742 ROFL` in `3627` unspent outputs |
...
| `3617` | `2a79b75f7a2f58297a08…` | [@ywltby](https://github.com/ywltby) | `排位，比世界赛决赛还难打。` | `1` | `0.00038146` | 2026-09-24 23:12 UTC |

### Miners

| miner | blocks | share |
|---|--:|--:|
| [@ywltby](https://github.com/ywltby) | `1518` | `41.9%` |
...
| [@ywltby](https://github.com/ywltby) | `rofl1qrrj2pn86jy9ylnatdwuqfazq0ur5pv7xq9lja3` | `734.92248571 ROFL` |
...
<sub>Rendered from `chain/blocks.jsonl` at height 3626. Verify it yourself: <code>python3 verify.py</code></sub>
